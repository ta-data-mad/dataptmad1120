...
#Input checker
accepted_inputs=['zero','one','two', 'three','four','five']
accepted_ops=['plus','minus']

if (a not in accepted_inputs) or (b not in accepted_ops) or (c not in accepted_inputs):
    print("I am not able to answer this question. Check your input.")

#Calculations
#dictionary to convert string to integer
