...
# first, we will create a dictionary with the possible values and outcomes that might come out of the calculation

numbers = {"one": 1, "two": 2, "three": 3, "four": 4, "five": 5, "six": 6, "seven": 7, "eight": 8, "nine": 9, "ten": 10}

# then we create a more straight forward formula to come up with the result and create exceptions in case there is a wrong input
...
try:
    ...
    print("I am not able to answer this question. Check your input.")
finally: #this string is always shown
