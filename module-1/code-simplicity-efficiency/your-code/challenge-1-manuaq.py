...
a = input('Please choose your first number 0 (zero) to 5 (five): ')

if type(a) == str:
    print("Your input: ", a, "was recorded.", "\n")
    print("But you should know that you can introduce actual numbers for the calculator. As 0,1,2,3,4 or 5", "\n")
    print("It should be easier and less prone to errors for your calculations to use numbers.", "\n")
    print("If you still decide to write numbers in the form of English word, here is a friendly reminder of the spelling I'm able to understand: zero (0), one (1), two (2), three (3), four (4), five (5)")
...
c = input('Please choose your second number 0 (zero) to 5 (five): ')

#     print("But you should know that you can introduce actual numbers for the calculator. As 0,1,2,3,4 or 5" 
#     print("It should be easier and less prone to errors for your calculations.
#     print("If you still decide to write numbers in the form of English word, here is a friendly reminder of the spelling I'm able to understand", n\n\, "zero (0), one (1), two (2), three (3), four (4), five (5)")
# else:
#     continue
...
# if a == type(int) and b == type(str):
# if a == type(str) or b == type(str):
#     print("Your number: ", a, "was recorded.)
#     print("But you should know that you can introduce actual numbers for the calculator. As 0,1,2,3,4 or 5" 
#     print("It should be easier and less prone to errors for your calculations.
#     print("If you still decide to write numbers in the form of English word, here is a friendly reminder of the spelling I'm able to understand", n\n\, "zero (0), one (1), two (2), three (3), four (4), five (5)")
