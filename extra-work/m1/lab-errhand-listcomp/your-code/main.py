...
string_non_vowels=''
for i in non_vowels:
    string_non_vowels=string_non_vowels+i
print(string_non_vowels)
...
capital_letters=[i for i in test_string if i!=i.lower()]
...
non_consonants=['a','e','i','y','o','u',' ']
consonants=[i for i in sentence if i.lower() not in non_consonants]
print(consonants)
...
flatten_list= [k for i in list_of_lists for k in i]
print(flatten_list)
